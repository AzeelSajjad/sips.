...
const onboardingSlides: OnboardingSlide[] = [
    ...
    },
    {
        ...
        description: "Search cafes by location and discover drinks they offer. Filter by matcha, boba, espresso, and more",
        icon: "map",
        color: "#D2691E"
    },
    {
        title: "Rank Drinks You Love",
        description: "Compare drinks head-to-head and build your personal ranking. Your preferences help others discover great drinks",
        icon: "trophy",
        color: "#CD853F"
    },
    {
        title: "Share with Friends",
        description: "Connect with friends, see their rankings, and discover new drinks together",
        icon: "people",
        color: "#A0522D"
    }
];
